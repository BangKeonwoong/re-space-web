              ...
              <div className="mt-4">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-sm font-semibold text-gray-500 hover:text-black px-3 py-2 rounded-lg hover:bg-gray-100"
                  >
                    수정
                  </button>
                </div>
            ...
            {!loading &&
              products.map((product) => (
                <tr key={product.id}>
                  ...
                  <td className="p-4">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-semibold ${product.is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'
                        }`}
                    >
                  ...
                  <button
                    onClick={() => onEdit(product)}
                    className="text-gray-400 hover:text-black px-3 py-2 rounded-lg hover:bg-gray-100"
                  >
                    수정
                  </button>
                  </td>
