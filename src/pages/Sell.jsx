    ...
    return (
        <div className="pt-32 pb-20 px-6 max-w-3xl mx-auto">
            ...
            <div className="bg-white border boundary-gray-200 rounded-3xl p-8 shadow-sm">
                <div className="border-2 border-dashed border-gray-200 rounded-2xl p-12 flex flex-col items-center justify-center text-gray-400 hover:border-lime-500 hover:text-lime-600 transition-colors cursor-pointer group">
                    <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mb-4 group-hover:bg-lime-50">
                        <Camera size={32} />
                    </div>
